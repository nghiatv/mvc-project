                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <?php if (isset($_SESSION['valid']) && isset($_SESSION['username'])) : ?>
                                    <li><a href="dashboard">Xin chào! <strong><?php echo $_SESSION['username'] ?></strong></li>
                                    <li><a href="login/logout">Logout</li>
                                <?php else : ?>
